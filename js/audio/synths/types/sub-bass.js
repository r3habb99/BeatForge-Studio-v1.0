 ...
 * Generates deep sub-bass sounds using sine wave
 */
 ...
 */
export function playSubBass(track, noteInfo, time, duration, vol) {
...
/**
 * Render sub bass sound in offline context
 ...
 */
export function renderSubBass(ctx, track, noteInfo, time, duration, vol, masterGain, reverbNode, delayNode) {
