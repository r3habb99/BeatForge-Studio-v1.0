...
import { resumeAudioContext, getAudioContext } from '../../audio/audioEngine.js';
...
export function setupStopButton() {
    document.getElementById('stopBtn').addEventListener('click', () => {
        ...
        state.isPlaying = false;
        state.currentStep = 0;
        document.querySelectorAll('.grid-col').forEach(c => c.classList.remove('bg-gray-800', 'border-t-2', 'border-blue-500'));
        updatePlayButtonUI(false);
    });
}
